...
import com.omaykan.storefront.core.network.dto.GoogleTokenResponseDto
 ...
 * than posting the code to the backend keeps `/api/customer/auth/google` to a
 * single payload shape shared with the web storefront — see CustomerDto.
 *
