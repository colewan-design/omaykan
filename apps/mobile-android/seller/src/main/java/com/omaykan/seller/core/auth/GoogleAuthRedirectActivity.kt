 ...
 * an intent at `com.omaykan.seller:/oauth2redirect`, and none of that should
 ...
 * merchant lands back on a browser page showing a URL they cannot read.
 *
...
class GoogleAuthRedirectActivity : ComponentActivity() {
    ...
    private fun handle(intent: Intent?) {
        ...
        // the stack, and starting a second copy would put a second order list
        // over the one the merchant was reading.
        startActivity(
