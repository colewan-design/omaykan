...
class SellerEmailVerification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->subject('Verify your Omaykan seller email')
            ->greeting('Hi '.$notifiable->name.',')
            ->line('Please verify this email address before signing in to your Omaykan seller account.')
